...
import { ShoppingCart, Star, Repeat } from "lucide-react";
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              ...
              to meet your healing needs. Subscribe and save 5%!
            </p>
          </div>
                  ...
                  <div className="p-6 space-y-4 bg-gradient-to-b from-white/95 to-white/90 backdrop-blur-sm">
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-lg p-3 mb-4">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className="text-sm font-semibold text-green-800">Subscribe & Save 5%</span>
                      </div>
                      <p className="text-xs text-green-700">
                        Monthly delivery for ${(product.price * 0.95).toFixed(2)}
                      </p>
                    </div>
                    
                    <div className="space-y-2">
                      <Button 
                        className="w-full bg-green-600 hover:bg-green-700 text-white transition-all duration-300 group/btn"
                        size="lg"
                        onClick={() => handleSubscribeClick(product)}
                      >
                        <Repeat className="w-4 h-4 mr-2 group-hover/btn:animate-spin transition-transform" />
                        Subscribe & Save 5%
                      </Button>
