        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <div className="prose prose-gray max-w-none space-y-6">
            <section>
              ...
              <p>
                These Terms of Service ("Terms") constitute a legally binding agreement between Dream Tattoo Company LLC ("Company," "we," "us," or "our") and you ("you," "user") governing your access to and use of BlueDreamBudder.com, our online store, and all related tools, features, and services, including the AI Tattoo Healing Tracker (collectively, the "Services"). By accessing or using the Services, you agree to be bound by these Terms and our Privacy Policy. If you do not agree, do not use the Services.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                You must be at least 18 years old (or the age of majority where you live) to use the AI Tattoo Healing Tracker and to purchase products. By using the Services, you represent that you meet this requirement and are legally able to enter into these Terms.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li><strong>AI Tattoo Healing Tracker.</strong> Users may upload tattoo images for automated analysis and a generated report with observations and general self-care suggestions.</li>
              </ul>
              <p className="mt-3">
            ...
            <section>
              ...
              <p className="font-semibold text-red-600 mb-2">
                The Services (including the AI Tattoo Healing Tracker) are for informational and educational purposes only and are not medical advice, diagnosis, or treatment.
              </p>
              <ul className="list-disc pl-6 space-y-1">
            ...
            <section>
              ...
              <p>
                Your use of the Services is subject to our Privacy Policy (incorporated by reference). By using the AI Tattoo Healing Tracker, you consent to the processing of your uploaded images and related data as described in the Privacy Policy. Do not upload sensitive personal data you do not wish to share.
              </p>
            </section>
