...
export const ActivationCodesPanel = () => {
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center py-8">
        <p className="text-muted-foreground">Loading activation codes...</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold mb-2">Heal-AId™ Activation Codes</h2>
...
export default ActivationCodesPanel;
